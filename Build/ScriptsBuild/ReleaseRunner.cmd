...
set outputBinFolder=%artifactsfolder%\Binaries
set outputReportsFolder=%artifactsfolder%\Reports
set packagesFolder=%CD%\..\Packages
set nunitExePath=%packagesFolder%\nUnit\NUnit-2.5.6.10205\bin
set taskId=%1
set msBuildProperties=Configuration=%CI_Configuration%;OutputPath="%outputBinFolder%"\;Platform=%buildType%;Optimize=true;BuildReportsFolder="%outputReportsFolder%";TaskIdName=%taskId%;nUnitPath="%nunitExePath%";nUnitFramework=%nunitFramework%
